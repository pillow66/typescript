 ...
 * 某些场景,应为一个可选参数设置默认值
 */
function F(foo, bar, foobar) {
    if (bar === void 0) { bar = 0; }
    if (foobar === void 0) { foobar = 1; }
...
var J = (function () {
    ...
    J.prototype.setName = function (val) {
        this._name = val;
    };
    return J;
}());
...
;
K("url/number", function (list) {
    console.log(list);
});
K("url/string", function (list) {
    console.log(list);
});
/**
 * tag函数和标签模板
...
;
var l = (_a = ["hello ", " ", " world"], _a.raw = ["hello ", " ", " world"], L(_a, g, 1 + 2));
...
var Person = (function () {
    ...
    Person.prototype.delay1 = function () {
        //不使用箭头函数,this指向setTimeout回调函数所在全局对象
        setTimeout(function () {
            console.log("delay1:", this._name);
        }, 500);
    };
    Person.prototype.delay2 = function () {
        var _this = this;
        //使用箭头函数,this指向Person实例对象
        setTimeout(function () {
            console.log("delay2:", _this._name);
        }, 500);
    };
    return Person;
}());
